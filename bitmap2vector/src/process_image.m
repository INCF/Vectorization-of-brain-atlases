function process_image(x, path_to_, compileFlag)
	...
	printf("DONE FORMING AND PRINTING ADJACENCY LIST\n");
	fflush(stdout);
	if(strcmp(compileFlag, "1"))
	...
	printf("DONE FORMING LINE SEGMENTS AND ISLAND LINE SEGMENTS\n");
	fflush(stdout);
	run line_segments.m
	...
	printf("DONE PRINTING PATHS POINT\n");
	fflush(stdout);
	if(strcmp(compileFlag, "1"))
