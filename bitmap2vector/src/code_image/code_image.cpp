...
/*
	...
	cout << "for i = 1:" << image.rows << endl << "for j = 1:" << image.cols << endl << "myImg(i, j, 1) = col_code(matrix_code(i, j) , 1);" << endl;
	cout << "myImg(i, j, 2) = col_code(matrix_code(i,j) , 2);" << endl;
	cout << "myImg(i, j, 3) = col_code(matrix_code(i,j) , 3);" << endl;
